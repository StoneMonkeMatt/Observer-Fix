    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-32">
      ...
      <div className="glass-panel p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/60">Persistence Thresholds</h4>
            <p className="text-sm text-white/40 leading-relaxed">
              When agent activity leads to a <strong>Duality</strong> score above the threshold, <strong>High Duality Persistence</strong> is registered, marking a transition toward stable symbolic resonance.
            </p>
            <div className="p-4 bg-white/5 rounded-xl border border-white/5">
              <div className="flex justify-between items-center mb-2">
                <span className="text-[10px] font-bold uppercase tracking-widest opacity-40">High Duality Persistence</span>
