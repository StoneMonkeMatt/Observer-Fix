...
export const ACTIVE_SYMBOL_SET_CONFIG = {
  ...
  implementationNote: "Symbols with weight < 20 or those in highly specialized domains (e.g., Footwear, Sports_Equipment) may have lower manifestation rates in general-purpose simulations."
};
