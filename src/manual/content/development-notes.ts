...
export const DEVELOPMENT_NOTES = [
  {
    date: "2026-03-31",
    title: "Doctrine Alignment: High Duality Persistence Proxy",
    status: "Correction of internal terminology to align with the white paper's three-stratum architecture.",
    filesToAdapt: [
      { file: "src/types.ts", changes: "Reinterpretation of 'highDualityPersistence' as a proxy diagnostic." },
      { file: "src/logic/metrics.ts", changes: "Refinement of persistence triggers to reflect structural thresholds." }
    ],
    newFiles: [],
    primaryGoal: "Align the simulation's 'high duality' terminology with the formal three-stratum hypothesis defined in the white paper.",
    notes: "The current simulation boolean 'highDualityPersistence' is a proxy and not the formal observer concept implied by the research discussion. The white paper’s formal hypothesis is a three-stratum architecture consisting of: (1) kernel, (2) navigational/control layer, and (3) expressive periphery. High duality phenomena, if studied, should be treated as structural diagnostics or comparative evidence rather than a built-in theoretical layer. The current boolean is based on persistent duality threshold crossing and inventory change, and was renamed to avoid overclaiming theoretical alignment.",
    keywords: "high duality, persistence, doctrine, white paper, strata, kernel, navigational, periphery, proxy, diagnostics"
  },
  {
    date: "2026-03-31",
