...
export const STRUCTURAL_LOGIC_SUMMARIES = [
  ...
  {
    title: "High Duality Persistence",
    desc: "High duality persistence is checked by monitoring the Duality metric. If duality crosses the threshold (currently 0.8) and remains above it for the duration of the persistence requirement (currently 2 Steps), a persistence event is registered."
  }
];
