...
export const EVENT_VOCABULARY = [
  ...
  { 
    id: "high_duality_candidate", 
    label: "High Duality Candidate",
    category: "Emergence",
    trigger: "Duality > Threshold",
    description: "A state has qualified for high duality inspection.",
    question: "When did the state become interesting enough to watch?",
    interpretation: "Indicates high complexity or novelty."
  },
  { 
    id: "high_duality_persistence", 
    label: "High Duality Persistence",
    category: "Emergence",
    trigger: "Persistence Met",
    description: "A persistent duality signal has been registered.",
    question: "When did a coherent pattern manifest?",
    interpretation: "Indicates the birth of a stable structural feature."
  },
  { 
