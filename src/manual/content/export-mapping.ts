...
export const EXPORT_MAPPING = [
  ...
  { 
    ...
    fields: "history, highDualityPersistence, highDualityStep, seed, iterationsRun, bestScoreStep, plateauStartStep, lastInventoryChangeStep, lastOrderChangeStep, lastAcceptedChangeStep, lastMeaningfulAcceptedStep" 
  },
  { 
