...
export const PARAMETER_REGIME_PROFILES = {
  ...
  threshold: [
    { id: "standard_high_duality", description: "Standard threshold for persistence detection." },
    { id: "strict_high_duality", description: "High threshold requiring strong evidence for persistence." },
    { id: "permissive_high_duality", description: "Low threshold for early registration of signals." }
  ],
  constraint: [
