...
export const PARAMETERS_MAPPING: ParameterMapping[] = [
  ...
  // Thresholds
  {
    key: "high_duality_threshold",
    label: "High Duality Threshold",
    canonicalName: "threshold",
    family: "Thresholds",
    description: "The minimum duality score required for a state to qualify as having 'high duality' or meaningful structure.",
    range: "0-1.0",
    type: "number",
    default: "0.8",
    effect: "Makes high duality qualification stricter.",
    exposure: "user-facing"
  },
