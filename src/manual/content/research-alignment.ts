...
export const RESEARCH_QUESTIONS = [
  ...
  { 
    ...
    description: "Does high duality persistence manifest at specific parameter thresholds?" 
  },
  { 
  ...
  { 
    ...
    description: "Does high duality persistence correlate with specific structural transitions?" 
  }
];
...
export const EVIDENCE_CHECKLIST = [
  {
    question: "Does a navigational layer manifest as a distinct regime?",
    check: "Check structuralSummary.highDualityPersistence vs parameterProfiles"
  },
  {
