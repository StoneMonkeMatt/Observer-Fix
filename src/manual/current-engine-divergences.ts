...
export const currentEngineDivergences: DivergenceEntry[] = [
  ...
  {
    id: "div-02",
    topic: "High Duality Threshold Naming",
    canonicalPosition: "The canonical key for the high duality threshold is 'highDualityThreshold'.",
    currentEnginePosition: "The current engine uses the key 'threshold' for this parameter.",
    divergence: "The current engine uses a generic key ('threshold') instead of the specific canonical key ('highDualityThreshold').",
    severity: "medium",
    relatedSections: ["part-01", "part-09"],
    status: "planned"
  },
