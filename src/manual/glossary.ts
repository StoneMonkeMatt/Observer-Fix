...
export const manualGlossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    definition: "A proxy signal for persistent structural stability that manifests when the simulation's duality score exceeds a specific threshold for a sustained period.",
    relatedTerms: ["duality", "high duality threshold", "high duality persistence steps"],
    sourceSectionIds: ["part-09"],
    authority: "canonical"
  },
  {
    term: "high duality threshold",
    definition: "The duality score boundary that must be crossed to begin the persistence count for high duality registration.",
    relatedTerms: ["high duality persistence", "duality"],
    sourceSectionIds: ["part-09"],
    authority: "canonical"
  },
  {
    ...
    relatedTerms: ["high duality persistence", "resilience"],
