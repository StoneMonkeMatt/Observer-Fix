          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <ManualDrawer title="Simulation Metrics (Outputs)">
                <div className="space-y-4">
                  ...
                  <LexiconItem 
                    ...
                    meaning="The average awareness weight of the sequence, used to trigger high duality persistence." 
                  />
                  <LexiconItem 
                    label="Kernel Purity" 
              ...
              <ManualDrawer title="System Constraints">
                <div className="space-y-4">
                  {PARAMETERS_MAPPING.filter(p => ["high_duality_threshold", "max_sequence_length", "max_simulation_depth", "architecture_mode"].includes(p.key)).map(param => (
                    <LexiconItem 
                      key={param.key}
                      label={param.label} 
                      dbLabel={param.key} 
          ...
          <div className="space-y-4">
            ...
            {PARAMETERS_MAPPING.filter(p => p.family === "Thresholds").map(param => (
              <LexiconItem 
                ...
                meaning={param.description} 
                effect={param.effect}
                notes={param.key === "high_duality_threshold" ? "Keep separate from future acceptance, plateau, and warning thresholds." : undefined}
              />
            ))}
          </div>
        </ManualDrawer>
