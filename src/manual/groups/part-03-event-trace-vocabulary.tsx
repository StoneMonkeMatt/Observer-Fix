  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 pt-6 border-t border-white/5">
        ...
        <ManualDrawer title="C. Emergence & Persistence (Events)">
          <div className="space-y-4">
            <p className="text-[10px] text-white/40 italic mb-4">Events tracking persistent properties and high duality persistence.</p>
