      ...
      <div className="space-y-6">
        ...
        <ManualDrawer title="2. Required Build Sequence">
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-white/40 italic">The schema must not encode engine reasoning, high duality persistence logic, kernel protection logic, or scoring logic.</p>
            </div>
        ...
        <ManualDrawer title="3. Architectural Constraint">
          <div className="space-y-4 text-[10px] text-white/50 leading-relaxed">
            ...
            <p>It records simulation configuration, state transitions, metrics, summaries, and event history. It does not decide whether high duality persistence was achieved, whether a kernel was valid, or how a score should be computed. Those decisions belong to the engine and analysis layers.</p>
          </div>
        </ManualDrawer>
