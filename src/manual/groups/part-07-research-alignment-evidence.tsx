        ...
        <ManualDrawer title="A. The Schema as a Research Bridge">
          <div className="space-y-6">
            <div className="space-y-4 text-[10px] text-white/40 leading-relaxed">
              ...
              <p>
                If the paper is asking about structural pressure, stratification, invariant preservation, navigational control, expressive expansion, and high duality persistence behavior, then the schema decides whether those things are properly recorded and compared.
              </p>
            </div>
          </div>
        </ManualDrawer>
