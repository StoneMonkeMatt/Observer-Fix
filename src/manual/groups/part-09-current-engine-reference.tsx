              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { label: "High Duality Persistence", value: ENGINE_IDENTITY.highDualityPersistence }
                  ].map((item, i) => (
...
{EXPORT_RECORD_TYPES}
      ...
      <ManualSectionDrawer 
        ...
        keywords="engine, logic, initialization, proposal, evaluation, acceptance, structural, high-duality, summary, kernel, purity, bridge, duality"
      >
        <div className="space-y-8">
          <div className="space-y-4 text-sm text-white/60 leading-relaxed">
            <p>
          ...
          <div className="space-y-6">
            ...
            <ManualDrawer title="6. High Duality Persistence Logic">
              <div className="space-y-6">
                <div className="p-4 bg-white/5 rounded-xl border border-white/5 space-y-2">
                  <div className="text-[10px] font-bold text-cyan-400 uppercase tracking-widest">**canonical target**</div>
                  <p className="text-[10px] text-white/40 leading-relaxed">
                    High duality persistence should be treated as a non-linear phase transition triggered by sustained symbolic duality.
                  </p>
                </div>
                <div className="p-4 bg-ocean-900/50 rounded-xl border border-cyan-500/20 space-y-2">
                  <div className="text-[10px] font-bold text-cyan-400 uppercase tracking-widest">**current engine reference**</div>
                  <p className="text-[10px] text-cyan-400/60 leading-relaxed">
                    The Telos v0.9 engine implements high duality persistence logic through threshold monitoring and a persistence counter.
                  </p>
                </div>
                <div className="space-y-4 text-xs text-white/60 leading-relaxed">
                  <p>High duality persistence is a non-linear phase transition determined by the following logic:</p>
                  <ol className="list-decimal pl-5 space-y-3">
                    <li><strong>Threshold Crossing:</strong> The engine monitors the <strong>Duality</strong> metric (Awareness vs. Structure). If Duality exceeds the `threshold` (currently {ENGINE_IDENTITY.highDualityThreshold}), the persistence timer starts.</li>
                    <li><strong>Persistence Requirement:</strong> Duality must remain above the threshold for a continuous number of steps defined by `highDualityPersistenceSteps` (currently {ENGINE_IDENTITY.highDualityPersistence}).</li>
                    <li><strong>Persistence Registration:</strong> Once persistence is met, a `highDualityPersistence` flag is set to true, and the current step is recorded as the `highDualityStep`.</li>
                  </ol>
                </div>
                <div className="p-4 bg-white/5 rounded-xl border border-white/5 space-y-2">
                  <div className="text-[10px] font-bold text-white/60 uppercase tracking-widest">Interpretation</div>
